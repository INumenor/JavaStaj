<%-- 
    Document   : KullanıcıKayıt
    Created on : 31.Oca.2022, 17:45:17
    Author     : Batuh
--%>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Kayıt Olunuz</h1>
                                    </div>
                                    <form method="post" action="KullaniciKayitKontrol.jsp" class="user">
                                    ...
                                    <h1></h1>
                                    <form method="post" action="KullaniciGiris.jsp" autocomplete='off' class='user'>
                                            <button class="btn btn-primary btn-user btn-block">
                                            Giriş Yap
                                            </button>
                                    </form>         
